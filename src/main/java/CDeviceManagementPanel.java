...
//        java.util.List<User> list=this.queryAllUser();
    ...
    private void button6ActionPerformed(ActionEvent e) {
        if(JOptionPane.showConfirmDialog(null, "Sure to update the device information?", "Update",JOptionPane.YES_NO_OPTION)==0) //返回值为0或1
        {
            String sql = null;
    ...
    private void button1ActionPerformed(ActionEvent e) {
        if(JOptionPane.showConfirmDialog(null, "Sure to add the device?", "Add",JOptionPane.YES_NO_OPTION)==0) //返回值为0或1
        {
            String sql = null;
